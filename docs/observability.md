...
117 rules in total: 99 metric-based in `prometheus/rules/`, and 18 log-based in
`loki/rules/`.
...
against the broken rule too. Coverage is seventy-nine rules of 99 so far — the five
...
[#604](https://github.com/Gerrrt/HomeLab/issues/604), and all thirty in
`host.rules.yaml` —
