...
105 rules in total: 87 metric-based in `prometheus/rules/`, and 18 log-based in
`loki/rules/`.
...
against the broken rule too. Coverage is sixty-seven rules of 87 so far — the five
