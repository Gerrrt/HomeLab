...
78 rules in total: 62 metric-based in `prometheus/rules/`, and 16 log-based in
`loki/rules/`.
...
62 rules across eleven files in `prometheus/rules/`:
...
against the broken rule too. Coverage is forty-one rules of 62 so far — the five
