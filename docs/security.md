...
| Losing visibility of a failure | 109 alert rules, 30 days of metrics and logs |
...
- **SNMPv3 authPriv, per poll**
  ...
  from the lab segment. The UPS card follows on the same procedure. The
  firewall **cannot**
