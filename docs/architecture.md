...
| `carbuncle` (10.0.30.54) | 🟢 30 | *(none — Windows)* | **Not built yet** — Windows 11 Pro endpoint — Tier 2. Runs per session, not continuously. Scraped by `alexander` on `9182`; it pushes nothing, and runs no Alloy ([ADR-0029](adr/0029-size-the-lab-domain-and-separate-its-namespace-and-clock.md)) |
| `siren` (10.0.30.55) | 🟢 30 | *(none — Windows)* | **Not built yet** — Windows 11 Pro endpoint — Tier 2. Runs per session, not continuously. Scraped by `alexander` on `9182`; it pushes nothing, and runs no Alloy ([ADR-0029](adr/0029-size-the-lab-domain-and-separate-its-namespace-and-clock.md)) |
