...
- **Dashboards and alerting as code.** 7 provisioned dashboards, 140 panels, and
  90 alert rules — 74 metric-based in Prometheus, 16 log-based in Loki — sharing
...
- **Supply chain pinned by digest.** Every image carries both a tag and a
  ...
  at all.
- **Documented decisions and runbooks.** 27 ADRs covering what was chosen
...
│   ├── compose.yaml
│   ├── prometheus/           # config, file_sd targets, 74 alert rules
