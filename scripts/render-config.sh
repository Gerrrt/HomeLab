...
# SNMPv3 (ADR-0035) is two: SNMP_AUTHPASS_<X> and SNMP_PRIVPASS_<X>, the
...
COMPOSE_VARS=(
  GRAFANA_ADMIN_USER GRAFANA_ADMIN_PASSWORD GRAFANA_RENDERER_TOKEN
  STEPCA_PASSWORD
  PAPERLESS_SECRET_KEY PAPERLESS_DBPASS PAPERLESS_ADMIN_PASSWORD
)
