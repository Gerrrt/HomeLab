...
# thin-pool-state (#538), pve-firewall (#576) and drift-check (#470). Adding one
# is a row plus a unit under systemd/agent/, not a new script: the first
# version of this was install-agent-collectors.sh and hardcoded one job, which
# lasted exactly as long as it took for the second collector to need shipping.
#
